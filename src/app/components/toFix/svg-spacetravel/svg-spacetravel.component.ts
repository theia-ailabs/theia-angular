...
@Component({
  selector: 'app-svg-spacetravel',
  templateUrl: './svg-spacetravel.component.html',
  styleUrls: ['./svg-spacetravel.component.css']
})
export class SvgSpacetravelComponent {
  ngOnInit(): void {
    function animation() {
      let isLeft = false;
      /**
      ...
      for (let i = 0; i < 3; i++) {
        ...
        document.querySelector("#note-1").classList.add("notes");
        document.querySelector("#note-2").classList.add("notes");
        gsap.set(clone1, {
          attr: {
            d:
